...
// Prefer a dedicated JWT env var, then fall back to SUPABASE_SERVICE_ROLE_KEY as-is.
const supabaseServiceKey = process.env.SUPABASE_SERVICE_JWT || process.env.SUPABASE_SERVICE_ROLE_KEY || '';
