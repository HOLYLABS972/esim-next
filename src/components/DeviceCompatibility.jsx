...
const DeviceCompatibility = () => {
  ...
  const brands = {
    all: { name: t('deviceCompatibility.allBrands', 'Все бренды'), emoji: '🌐' },
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-lg">
          {t('deviceCompatibility.description', 'Найдите модель телефона и проверьте поддержку eSIM')}
        </p>
      </div>
      ...
      <div className="max-w-2xl mx-auto mb-8">
        <div className="relative">
          <input
            ...
            placeholder={t('deviceCompatibility.searchPlaceholder', 'Найти модель')}
        ...
        <div className="max-w-4xl mx-auto mb-12">
          {filteredDevices.length > 0 ? (
            ...
            <div className="bg-gray-100 dark:bg-gray-800/90 backdrop-blur-md rounded-lg border border-gray-200 dark:border-gray-700/50 p-6 text-center">
              <p className="text-gray-600 dark:text-gray-400">{t('deviceCompatibility.noDeviceFound', 'Устройство не найдено. Попробуйте другой запрос.')}</p>
            </div>
          )}
        </div>
      )}
      ...
      <div className="mt-8 grid md:grid-cols-2 gap-6">
        <div className="bg-gray-100 dark:bg-gray-800/90 backdrop-blur-md rounded-lg border border-gray-200 dark:border-gray-700/50 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white">{t('deviceCompatibility.forIphone', 'Для iPhone')}</h3>
          </div>
          <ol className="space-y-2 text-gray-600 dark:text-gray-300 text-sm">
            <li>1. {t('deviceCompatibility.iphoneStep1', 'Откройте Настройки')}</li>
            <li>2. {t('deviceCompatibility.iphoneStep2', 'Нажмите Сотовая связь')}</li>
            <li>3. {t('deviceCompatibility.iphoneStep3', 'Если видите "Добавить тариф" или "Добавить eSIM" — ваш телефон поддерживает eSIM')}</li>
            <li>4. {t('deviceCompatibility.iphoneStep4', 'Также наберите *#06# — если видите EID, eSIM поддерживается')}</li>
          </ol>
        </div>
        ...
        <div className="bg-gray-100 dark:bg-gray-800/90 backdrop-blur-md rounded-lg border border-gray-200 dark:border-gray-700/50 p-6">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-2xl">🤖</span>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white">{t('deviceCompatibility.forAndroid', 'Для Android')}</h3>
          </div>
          <ol className="space-y-2 text-gray-600 dark:text-gray-300 text-sm">
            <li>1. {t('deviceCompatibility.androidStep1', 'Откройте Настройки')}</li>
            <li>2. {t('deviceCompatibility.androidStep2', 'Перейдите в Сеть и интернет')}</li>
            <li>3. {t('deviceCompatibility.androidStep3', 'Нажмите Мобильная сеть или SIM-менеджер')}</li>
            <li>4. {t('deviceCompatibility.androidStep4', 'Если видите "Добавить оператора" — eSIM поддерживается')}</li>
            <li>5. {t('deviceCompatibility.androidStep5', 'Также наберите *#06# для проверки EID')}</li>
          </ol>
        </div>
      </div>
    </div>
