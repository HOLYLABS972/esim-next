...
const FAQ = () => {
  ...
  const title = faqPage?.title ?? t('contact.faqTitle', 'Часто задаваемые вопросы');
  const description = faqPage?.description ?? t('contact.faqDescription', 'Быстрые ответы на частые вопросы');
