          ...
          {selectedPackage && (
            <div className="p-6">
              <div className="max-w-2xl mx-auto">
                ...
                {/* How to Use Section */}
                <div className="text-center">
                  <h3 className="text-2xl font-semibold text-gray-900 mb-6">Как использовать</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="flex flex-col items-center text-center p-4">
                      <div className="bg-yellow-100 p-3 rounded-full mb-3">
                        <Zap className="w-8 h-8 text-yellow-600" />
                      </div>
                      <h4 className="font-semibold text-gray-900 mb-2">Мгновенная активация</h4>
                      <p className="text-sm text-gray-600">Подключение сразу после покупки</p>
                    </div>
                    <div className="flex flex-col items-center text-center p-4">
                      <div className="bg-green-100 p-3 rounded-full mb-3">
                        <Shield className="w-8 h-8 text-green-600" />
                      </div>
                      <h4 className="font-semibold text-gray-900 mb-2">Безопасно и надёжно</h4>
                      <p className="text-sm text-gray-600">Доверяют миллионы путешественников</p>
                    </div>
                    <div className="flex flex-col items-center text-center p-4">
                      <div className="bg-blue-100 p-3 rounded-full mb-3">
                        <Globe className="w-8 h-8 text-blue-600" />
                      </div>
                      <h4 className="font-semibold text-gray-900 mb-2">Глобальное покрытие</h4>
                      <p className="text-sm text-gray-600">Оставайтесь на связи в любой точке мира</p>
                    </div>
                  </div>
                </div>
              </div>
