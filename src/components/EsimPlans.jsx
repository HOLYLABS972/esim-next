  ...
  const handleCountrySelect = async (country) => {
    ...
    try {
      ...
      if (plan1GB) {
        ...
        toast.error(`${t('errors.noPackagesAvailable', 'Нет пакетов для')} ${country.name || country.code}`, {
          duration: 3000,
          style: {
            background: '#FEE2E2',
            color: '#991B1B',
          ...
          <div className="max-w-5xl mx-auto">
              ...
              <div className="p-4 sm:p-6">
                <div className="flex items-center justify-between gap-4 mb-4">
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                    {storeCountriesCount} {t('plans.countries', 'Стран')}
                    {storeRegionsCount > 0 && <> · {storeRegionsCount} {t('plans.regions', 'регионов')}</>}
                  </p>
                </div>
            ...
            <div className="mb-6">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                {t('plans.globalAndRegional', 'Глобальные и региональные')}
              </h2>
            ...
            <div>
              <div className="p-4 sm:p-6 border-b border-gray-100 dark:border-gray-700">
                {searchTerm ? (
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
                    {t('search.searchingFor', 'Поиск по:')} <span className="text-blue-600 dark:text-blue-400">{searchTerm}</span>
                  </h2>
                ) : (
                  <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
                    {t('search.popularDestinations', 'Популярные:')}
                  </h2>
                )}
              </div>
              ...
              <div className="px-4 sm:px-6 py-3 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
                <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                  {t('plans.allCountries', 'Все страны')}
                </h3>
                {!searchTerm && (
                  <button
                    type="button"
                  ...
                  >
                    {showAllCountries ? t('plans.showLess', 'Свернуть') : t('plans.showAll', 'Показать все')}
                  </button>
                )}
              </div>
                                  ...
                                  <div className="flex items-center space-x-3">
                                    ...
                                    <div className="text-left">
                                      <h3 className="text-sm font-semibold text-gray-900 dark:text-white">
                                        {t('plan.globalPlans', 'Глобальные тарифы')}
                                      </h3>
                                      <p className="text-xs text-gray-500 dark:text-gray-400">
                                        {t('plan.worksIn', 'Работает в 100+ странах')}
                                      </p>
                                    </div>
                                  </div>
